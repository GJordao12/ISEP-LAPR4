...
public class AssociateTeamCollaboratorController {
    ...
    public Iterable<CollaboratorDTO> teamCollaboratorsAllowedToJoinTeam(TeamDTO teamDTO){
        this.team = teamDTOParser.valueOf(teamDTO);
        return this.listCollaboratorService.teamCollaboratorsAllowedToJoinTeam(this.team);
    }

    public void associateTeamCollaboraotr(CollaboratorDTO collaboratorDTO) {
        ...
        teamRepository.saveTeamCollaborator(this.team,colab);
    }
}
